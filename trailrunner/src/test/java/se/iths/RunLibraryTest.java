...
public class RunLibraryTest {
    ...
    public void runDetailsAreFetchedCorrectly() {
        ...
        String expected = "Löprunda 1" + System.lineSeparator() + "-----------" + System.lineSeparator() +
        "Datum: 2024-01-02" + System.lineSeparator() + "Distans: 4.0 km" + System.lineSeparator() +
        "Tid: 0:14:30" + System.lineSeparator() + "Medelhastighet: 16.6 km/h" +
        System.lineSeparator() + "Kilometer-tid: 3:63/km" + System.lineSeparator();
